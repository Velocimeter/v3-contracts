...
contract Deployment is Script {
   ...
   // address private constant FLOW = 0x2b591e99afE9f32eAA6214f7B7629768c40Eeb39;
    ...
    function run() external {
        ...
        // Gauge factory
        GaugeFactory gaugeFactory = new GaugeFactory(); // already exists need to set it
        ...
        // Pair factory
        PairFactory pairFactory = new PairFactory(); // already exists need to set it

        // Router
        Router router = new Router(address(pairFactory), WPLS);  // already exists need to set it
