...
contract OptionTokenV4Test is BaseTest {
    ...
    function testSetVeDiscount() public {
        vm.startPrank(address(owner));
        assertEq(oFlowV4.veDiscount(), 10);
        vm.expectEmit(true, false, false, false);
        emit SetVeDiscount(50);
        oFlowV4.setVeDiscount(50);
        assertEq(oFlowV4.veDiscount(), 50);
        vm.stopPrank();
    }
    ...
    function testExerciseVe() public { 
        ...
        uint256 discountedPrice = oFlowV4.getVeDiscountedPrice(TOKEN_1);
