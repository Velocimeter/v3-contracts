...
contract VotingEscrowV2 is IERC721, IERC721Metadata, IVotes {
    enum DepositType {
        DEPOSIT_FOR_TYPE,
        CREATE_LOCK_TYPE,
    ...
    constructor(address token_addr, address art_proxy, address _owner, int128 _maxLockTime, uint256 _csrNftId) {
        token = token_addr;
        voter = msg.sender;
        team = msg.sender;
        artProxy = art_proxy;
        ...
        MAXTIME = uint256(int256(_maxLockTime));
        iMAXTIME = _maxLockTime;
    ...
    string constant public name = "veFLOW";
    string constant public symbol = "veFLOW";
